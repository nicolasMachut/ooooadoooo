(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('ooooadooooApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-ooooadooooApp-error');
                var entityKey = httpResponse.headers('X-ooooadooooApp-params');
                if (errorHeader) {
